...
{
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00573519', 'C00569905', 'C00548420', 'C00577296', 'C00586685', 'C00574277'])]
    public bool $presBenCarson = false;
    #[RecipientAttribute(party: PartyType::democrat, committeeIds: ['C00577130', 'C00492595', 'C00600817', 'C00406553', 'C00590646', 'C00590620', 'C00555615', 'C00589226', 'C00609602', 'C00589937', 'C00590240'])]
    public bool $presBernieSanders = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00580159', 'C00571711', 'C00559237'])]
    public bool $presBobbyJindal = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00577312', 'C00573154', 'C00564534'])]
    public bool $presCarlyFiorina = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00574251', 'C00573055', 'C00571778'])]
    public bool $presChrisChristie = false;
    #[RecipientAttribute(party: PartyType::other, committeeIds: ['C00623884'])]
    public bool $presEvanMcMullin = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00578245', 'C00571356'])]
    public bool $presGeorgePataki = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00458844', 'C00541292', 'C00500025', 'C00591214'])]
    public bool $presMarcoRubio = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00618371', 'C00580100', 'C00618389', 'C00608489', 'C00574533', 'C00618876', 'C00575373', 'C00580373', 'C00589879', 'C00614370', 'C00612903', 'C00586826', 'C00616789', 'C00628396', 'C00591610', 'C00591610', 'C00607283', 'C00587881'])]
    public bool $presDonaldTrump = false;
    #[RecipientAttribute(party: PartyType::democrat, committeeIds: ['C00575795', 'C00586537', 'C00495861', 'C00578997', 'C00540997', 'C00559765', 'C00570549', 'C00605204', 'C00566034', 'C00573741'])]
    public bool $presHillaryClinton = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00579458', 'C00571372', 'C00571950'])]
    public bool $presJebBush = false;
    #[RecipientAttribute(party: PartyType::democrat, committeeIds: ['C00581215', 'C00430819'])]
    public bool $presJimWebb = false;
    #[RecipientAttribute(party: PartyType::other, committeeIds: ['C00581199'])]
    public bool $presJillStein = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00582668', 'C00568840'])]
    public bool $presJimGilmore = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00581876', 'C00581868', 'C00582973'])]
    public bool $presJohnKasich = false;
    #[RecipientAttribute(party: PartyType::republican, committeeIds: ['C00578757', 'C00573733', 'C00388934', 'C00543157'])]
